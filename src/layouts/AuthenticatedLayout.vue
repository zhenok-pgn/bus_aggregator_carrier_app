<template>
  ...
  <v-navigation-drawer v-model="drawer" app>
    <v-list>
      <v-list-item prepend-icon="mdi-home" title="Организация" @click="navigate('/')"></v-list-item>
      <v-list-item
        prepend-icon="mdi-map-marker-path"
        title="Маршруты"
        @click="navigate('/routes')"
      ></v-list-item>
      <v-list-item
      ...
      <!--<v-list-group>
        ...
        <v-list-item prepend-icon="" title="Скидки" @click="navigate('/')"></v-list-item>
        <v-list-item prepend-icon="" title="Условия возврата" @click="navigate('/')"></v-list-item>
      </v-list-group>-->
    </v-list>
  </v-navigation-drawer>
